...
/* Index: PRIPADA_FK                                            */
/*==============================================================*/
create index PRIPADA_FK on NAROCILO (
ID_RACUNA ASC
)
go
...
/* Index: PRIPADA2_FK                                           */
/*==============================================================*/
create index PRIPADA2_FK on RACUN (
ID_NAROCILO ASC
)
go
...
alter table NAROCILO
   add constraint FK_NAROCILO_PRIPADA_RACUN foreign key (ID_RACUNA)
      references RACUN (ID_RACUNA)
go

alter table RACUN
   add constraint FK_RACUN_PRIPADA2_NAROCILO foreign key (ID_NAROCILO)
      references NAROCILO (ID_NAROCILO)
go
